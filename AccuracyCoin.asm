...
TEST_2007StressTest_Exit:
	...
	; ?? 02 ?? C0 ?? 46 ?? 46 ?? 03 ?? C0 ?? 06 ?? 06 ; Background fetch
	; ?? 04 ?? C1 ?? 6C ?? 6C ?? 05 ?? C1 ?? 60 ?? 60 ; Background fetch
	; ?? 06 ?? C1 ?? 60 ?? 60 ?? 07 ?? C1 ?? 06 ?? 06 ; Background fetch
	; ?? 08 ?? C2 ?? 66 ?? 66 ?? 09 ?? C2 ?? 66 ?? 66 ; Background fetch
	; ?? 0A ?? C2 ?? 24 ?? 24 ?? 0B ?? C2 ?? 66 ?? 66 ; Background fetch
	; ?? 0C ?? C3 ?? 66 ?? 66 ?? 0D ?? C3 ?? 64 ?? 64 ; Background fetch
	; ?? 0E ?? C3 ?? 60 ?? 60 ?? 0F ?? C3 ?? 60 ?? 60 ; Background fetch
	; ?? 10 ?? C4 ?? 66 ?? 66 ?? 11 ?? C4 ?? 66 ?? 66 ; Background fetch
	; ?? 12 ?? C4 ?? 18 ?? 18 ?? 13 ?? C4 ?? 0C ?? 0C ; Background fetch
	; ?? 14 ?? C5 ?? 6C ?? 6C ?? 15 ?? C5 ?? 60 ?? 60 ; Background fetch
	; ?? 16 ?? C5 ?? 76 ?? 76 ?? 17 ?? C5 ?? 72 ?? 72 ; Background fetch
	; ?? 18 ?? C6 ?? 66 ?? 66 ?? 19 ?? C6 ?? 7C ?? 7C ; Background fetch
	; ?? 1A ?? C6 ?? 3C ?? 3C ?? 1B ?? C6 ?? 7C ?? 7C ; Background fetch
	; ?? 1C ?? C7 ?? 3C ?? 3C ?? 1D ?? C7 ?? 7E ?? 7E ; Background fetch
	; ?? 1E ?? C7 ?? 66 ?? 66 ?? 1F ?? C7 ?? 66 ?? 66 ; Background fetch
	; ?? 00 ?? C0 ?? 3C ?? 3C ?? 01 ?? C0 ?? 18 ?? 18 ; Background fetch
	; ?? 02 ?? 00 ?? FF ?? FF ?? 00 ?? 00 ?? FF ?? FF ; Sprite fetch
	; ?? 00 ?? 00 ?? FF ?? FF ?? 00 ?? 00 ?? FF ?? FF ; Sprite fetch
	; ?? 00 ?? 00 ?? FF ?? FF ?? 00 ?? 00 ?? FF ?? FF ; Sprite fetch
	; ?? 00 ?? 00 ?? FF ?? FF ?? 00 ?? 00 ?? FF ?? FF ; Sprite fetch
	; ?? 00 ?? C0 ?? 66 ?? 66 ?? 01 ?? C0 ?? 38 ?? 38 ; Background fetch
	; ?? 02 ?? 02 ??                                  ; Dummy Background fetch
